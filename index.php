...
<div class="notification-toast" data-toast>
  ...
  <div class="toast-detail">
    ...
    <p class="toast-title">Nature Inspired Wall Art</p>
        ...
        ?>
          ...
          <div class="slider-item">
            ...
            <div class="banner-content">
              ...
              <p class="banner-text">Best selling products starts just at ₹
                <b><?php echo $row['banner_items_price']; ?></b>.00
              </p>

             <a href="./category.php?category=<?php echo 'women'; ?>" class="banner-btn">Shop now</a>
      ...
      <div class="testimonials-box">
        ...
        <div class="testimonial">
          ...
          <div class="testimonial-card">
            ...
            <p class="testimonial-name">Shree Nithi</p>
            ...
            The quality is exceptional, and it’s great to know I’m supporting eco-friendly products. The unique designs add a personal touch to my home. Highly recommend!
            </p>
          </div>
        </div>
      ...
      <div class="blog-container has-scrollbar">
        <div class="blog-card">
          ...
          <div class="blog-content">
            <a href="#" class="blog-category">Handmade Unique Items</a>

            <a href="#">
              <h3 class="blog-title">
              Handmade Decor Trends 2025: A Guide for Handmade Magic that transforms your space..
              </h3>
            </a>

            <p class="blog-meta">
              By <cite>Mrs Nikitha</cite> /
              <time datetime="2022-04-06">Apr 30, 2025</time>
            </p>
          </div>
        </div>
        ...
        <div class="blog-card">
          ...
          <div class="blog-content">
            <a href="#" class="blog-category">Eco-friendly</a>

            <h3>
              <a href="#" class="blog-title">Handmade Home Vibes: How to Win Hearts with Eco-Friendly Decor.</a>
            </h3>

            <p class="blog-meta">
              By <cite>Mrs Rakshitha</cite> /
              <time datetime="2022-01-18">May 1, 2022</time>
            </p>
          </div>
        </div>
        ...
        <div class="blog-card">
          ...
          <div class="blog-content">
            <a href="#" class="blog-category">Home Decor</a>

            <h3>
              <a href="#" class="blog-title">Transform Your Home: The Art of Handmade Wall Hangings & Decor..</a>
            </h3>

            <p class="blog-meta">
              By <cite>Mrs Keerthi</cite> /
              <time datetime="2022-02-10">May 3, 2025</time>
            </p>
          </div>
        </div>
        ...
        <div class="blog-card">
          ...
          <div class="blog-content">
            <a href="#" class="blog-category">Aesthetic Vibes</a>

            <h3>
              <a href="#" class="blog-title">Handmade Creations: Elevate Your Space with Unique Wall Hangings & More.</a>
            </h3>

            <p class="blog-meta">
              By <cite>Mr Pawan</cite> /
              <time datetime="2022-03-15">Apr 29, 2022</time>
            </p>
          </div>
        </div>
      </div>
