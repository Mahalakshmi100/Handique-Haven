          ...
          <div class="product-grid">
            ...
            $offset = ($page - 1) * $limit;
              ...
              foreach ($search_term_array as $term) {
                $term = trim($term);
                $search_like[] = "(product_title LIKE '%$term%' OR product_catag LIKE '%$term%')";
              }
              $search_condition = implode(" AND ", $search_like);
              
              $search_query = "SELECT * FROM products WHERE $search_condition ORDER BY product_id DESC LIMIT {$offset},{$limit}";
