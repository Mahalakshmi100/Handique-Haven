        ...
        <ul class="mobile-menu-category-list">
          ...
          <li class="menu-category">
            <button class="accordion-menu" data-accordion-btn>
              <p class="menu-title"><a href="./category.php?category=<?php echo "men"; ?>" class="menu-title">Category</a></p>
          ...
          <li class="menu-category">
            <button class="accordion-menu" data-accordion-btn>
              <p class="menu-title"><a href="./category.php?category=<?php echo "women"; ?>" class="menu-title">Shop</a></p>
