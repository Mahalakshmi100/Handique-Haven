...
<nav class="desktop-navigation-menu">
  <div class="container">
    <ul class="desktop-menu-category-list">
      ...
      <li class="menu-category">
        <a href="./category.php?category=<?php echo "men"; ?>" class="menu-title">Categories</a>
      </li>
      ...
      <li class="menu-category">
        <a href="orders.php?id=<?php echo (isset( $_SESSION['customer_name']))? $_SESSION['id']: 'unknown';?>" class="menu-title">Order</a>
      </li>
