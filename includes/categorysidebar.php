      ...
      ?>
        ...
        <li class="sidebar-menu-category">
          ...
          <ul class="sidebar-submenu-category-list" data-accordion>
            ...
            <!-- clothes category -->
            <?php
            if ($row['name'] == "Wall Hanging" || $row['name'] == "clothes") {
            ...
            <!-- Foot wear  category --> 
            <?php
            if ($row['name'] == "Table Decor" || $row['name'] == "footwear") {
            ...
            <!-- jewelry  category -->
            <?php
            if ($row['name'] == "Festival Decor" || $row['name'] == "jewelry") {
            ...
            <!-- perfume  category -->
            <?php
            if ($row['name'] == "Outdoor Decor" || $row['name'] == "perfume") {
            ...
            <!-- cosmetics  category -->
            <?php
            if ($row['name'] == "Lighting Solutions" || $row['name'] == "cosmetics") {
            ...
            <!-- cosmetics  category -->
            <?php
            if ($row['name'] == "Storage Solutions" || $row['name'] == "glasses") {
            ...
            <!-- cosmetics  category -->
            <?php
            if ($row['name'] == "Sustainable Decor" || $row['name'] == "bags") {
